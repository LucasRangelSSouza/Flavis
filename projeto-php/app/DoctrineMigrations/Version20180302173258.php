 ...
 */
class Version20180302173258 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE colaborador ADD cra VARCHAR(120) DEFAULT NULL');
        $this->addSql('ALTER TABLE produto_saida ALTER quantidade SET DEFAULT \'1\'');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE produto_saida ALTER quantidade SET DEFAULT \'(1)::numeric\'');
        $this->addSql('ALTER TABLE colaborador DROP cra');
    }
}
