 ...
 */
class Ambiente extends \AppBundle\Entity\Ambiente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'area', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'ocupanteFixo', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'ocupanteFlutuante', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'sigla', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'colaborador', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'observacao', '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'nomePerfil');//, '' . "\0" . 'AppBundle\\Entity\\Ambiente' . "\0" . 'localizacao'
        }
    ...
    public function setOcupanteFixo($ocupanteFixo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOcupanteFixo', array($ocupanteFixo));

        return parent::setOcupanteFixo($ocupanteFixo);
    }
    ...
    public function getOcupanteFixo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOcupanteFixo', array());

        return parent::getOcupanteFixo();
    }
    ...
    public function setOcupanteFlutuante($ocupanteFlutuante)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOcupanteFlutuante', array($ocupanteFlutuante));

        return parent::setOcupanteFlutuante($ocupanteFlutuante);
    }
    ...
    public function getOcupanteFlutuante()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOcupanteFlutuante', array());

        return parent::getOcupanteFlutuante();
    }
    ...
    public function setNomePerfil($nomePerfil)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomePerfil', array($nomePerfil));

        return parent::setnomePerfil($nomePerfil);
    }
