 ...
 */
class Bairro extends \AppBundle\Entity\Bairro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Bairro' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Bairro' . "\0" . 'cidade', '' . "\0" . 'AppBundle\\Entity\\Bairro' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\Bairro' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Bairro' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Bairro' . "\0" . 'deletedAt');
        }
    ...
    public function getNomeComCidade()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomeComCidade', array());

        return parent::getNomeComCidade();
    }
