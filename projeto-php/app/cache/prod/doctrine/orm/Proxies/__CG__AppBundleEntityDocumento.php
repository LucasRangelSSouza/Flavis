...
class Documento extends \AppBundle\Entity\Documento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'tipoDocumento', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'dataEmissao', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'dataValidade', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'pathFile', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'oldPathFile', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'observacoes', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Documento' . "\0" . 'deletedAt');
        }
