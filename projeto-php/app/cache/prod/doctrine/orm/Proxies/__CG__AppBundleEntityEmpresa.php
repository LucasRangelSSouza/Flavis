...
class Empresa extends \AppBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'cnpj', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'nomeFantasia', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'razaoSocial', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'cnae', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'deletedAt');
        }
    ...
    public function setCnae($cnae)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCnae', array($cnae));
    ...
    public function getCnae()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCnae', array());
