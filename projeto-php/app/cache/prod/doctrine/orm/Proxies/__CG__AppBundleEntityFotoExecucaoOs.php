 ...
 */
class FotoExecucaoOs extends \AppBundle\Entity\FotoExecucaoOs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'pathFile', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'oldPathFile', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\FotoExecucaoOs' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FotoExecucaoOs $proxy) {
