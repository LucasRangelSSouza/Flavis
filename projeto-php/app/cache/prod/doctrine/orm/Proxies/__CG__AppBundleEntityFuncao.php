 ...
 */
class Funcao extends \AppBundle\Entity\Funcao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Funcao' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Funcao' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\Funcao' . "\0" . 'descricao', '' . "\0" . 'AppBundle\\Entity\\Funcao' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Funcao' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Funcao' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Funcao $proxy) {
