 ...
 */
class HomologacaoOs extends \AppBundle\Entity\HomologacaoOs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'os', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'valor', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'parcelas', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'observacoes', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'codigoErp', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'isPago', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\HomologacaoOs' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HomologacaoOs $proxy) {
    ...
    public function setCodigoErp($codigoErp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodigoErp', array($codigoErp));

        return parent::setCodigoErp($codigoErp);
    }
    ...
    public function getCodigoErp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodigoErp', array());

        return parent::getCodigoErp();
    }
    ...
    public function setIsPago($isPago)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsPago', array($isPago));

        return parent::setIsPago($isPago);
    }
    ...
    public function getIsPago()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsPago', array());

        return parent::getIsPago();
    }
