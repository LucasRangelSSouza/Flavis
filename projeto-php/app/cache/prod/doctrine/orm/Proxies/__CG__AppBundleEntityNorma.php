 ...
 */
class Norma extends \AppBundle\Entity\Norma implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Norma' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Norma' . "\0" . 'sigla', '' . "\0" . 'AppBundle\\Entity\\Norma' . "\0" . 'numero', '' . "\0" . 'AppBundle\\Entity\\Norma' . "\0" . 'observacao', '' . "\0" . 'AppBundle\\Entity\\Norma' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Norma' . "\0" . 'updatedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Norma $proxy) {
