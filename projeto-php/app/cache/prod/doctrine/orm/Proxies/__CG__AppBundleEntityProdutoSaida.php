 ...
 */
class ProdutoSaida extends \AppBundle\Entity\ProdutoSaida implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProdutoSaida' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ProdutoSaida' . "\0" . 'produto', '' . "\0" . 'AppBundle\\Entity\\ProdutoSaida' . "\0" . 'quantidade', '' . "\0" . 'AppBundle\\Entity\\ProdutoSaida' . "\0" . 'valor');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProdutoSaida $proxy) {
