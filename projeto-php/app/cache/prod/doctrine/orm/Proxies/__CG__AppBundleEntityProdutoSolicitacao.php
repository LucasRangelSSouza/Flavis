 ...
 */
class ProdutoSolicitacao extends \AppBundle\Entity\ProdutoSolicitacao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProdutoSolicitacao' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ProdutoSolicitacao' . "\0" . 'produto', '' . "\0" . 'AppBundle\\Entity\\ProdutoSolicitacao' . "\0" . 'fornecedor', '' . "\0" . 'AppBundle\\Entity\\ProdutoSolicitacao' . "\0" . 'valor', '' . "\0" . 'AppBundle\\Entity\\ProdutoSolicitacao' . "\0" . 'quantidade');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProdutoSolicitacao $proxy) {
