 ...
 */
class ResponsavelCliente extends \AppBundle\Entity\ResponsavelCliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'cliente', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'funcao', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'telefone', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\ResponsavelCliente' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResponsavelCliente $proxy) {
