 ...
 */
class Telefone extends \AppBundle\Entity\Telefone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Telefone' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Telefone' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\Telefone' . "\0" . 'numero');
        }
