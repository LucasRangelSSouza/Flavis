...
class TipoDocumento extends \AppBundle\Entity\TipoDocumento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TipoDocumento' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TipoDocumento' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\TipoDocumento' . "\0" . 'observacoes', '' . "\0" . 'AppBundle\\Entity\\TipoDocumento' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\TipoDocumento' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\TipoDocumento' . "\0" . 'deletedAt');
        }
