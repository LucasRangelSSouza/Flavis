 ...
 */
class TipoNegocio extends \AppBundle\Entity\TipoNegocio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TipoNegocio' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TipoNegocio' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\TipoNegocio' . "\0" . 'descricao', '' . "\0" . 'AppBundle\\Entity\\TipoNegocio' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\TipoNegocio' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\TipoNegocio' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoNegocio $proxy) {
