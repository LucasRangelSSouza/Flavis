 ...
 */
class ValorPropriedadeEquipamento extends \AppBundle\Entity\ValorPropriedadeEquipamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ValorPropriedadeEquipamento' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ValorPropriedadeEquipamento' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\ValorPropriedadeEquipamento' . "\0" . 'valor', '' . "\0" . 'AppBundle\\Entity\\ValorPropriedadeEquipamento' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\ValorPropriedadeEquipamento' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\ValorPropriedadeEquipamento' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ValorPropriedadeEquipamento $proxy) {
