 ...
 */
class Tag extends \Application\Sonata\ClassificationBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'slug', 'createdAt', 'updatedAt', 'enabled', 'context');
        }
