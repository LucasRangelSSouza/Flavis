...
";
    ...
    // line 135
    public function block_logo1($context, array $blocks = array())
    {
        // line 136
        echo "            ";
        if (array_key_exists("admin_pool", $context)) {
            ...
            if ((("single_image" == $this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : null), "getOption", array(0 => "title_mode"), "method")) || ("both" == $this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : null), "getOption", array(0 => "title_mode"), "method")))) {
                // line 140
                echo "                            <img src=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : null), "", array())), "html", null, true);
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : null), "", array()), "html", null, true);
                echo "\">
                        ";
            }
            // line 142
...
//        $this->displayBlock('sonata_header_noscript_warning', $context, $blocks);
//        $this->displayBlock('logo1', $context, $blocks);                           //logo que fica no cabeçalho
