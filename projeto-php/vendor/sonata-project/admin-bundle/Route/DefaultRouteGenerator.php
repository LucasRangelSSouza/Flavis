...
//        echo 'Rastreabilidade! Método generate em DefaultRouteGenerator - perfil logado: '.$perfilLogado.'                             ';
    ...
    public function generateUrl(AdminInterface $admin, $name, array $parameters = array(), $absolute = false, $perfilLogado)
    {
        ...
        $perfilLogado = $this->perfilLogado();
//        echo 'Rastreabilidade! Método generateUrl em DefaultRouteGenerator - perfil logado: '.$perfilLogado.'                             ';
