...
class AdminSecurityController extends ContainerAware
{
    ...
    public function loginAction()
    {
        ...
        if ($user instanceof UserInterface) {
            ...
            $url = $this->container->get('router')->generate('sonata_user_profile_show', $parameters, $referenceType, $perfilLogado );
        ...
        if ($this->container->get('security.context')->isGranted('ROLE_ADMIN')) {
            ...
            return new RedirectResponse($refererUri && $refererUri != $request->getUri() ? $refererUri : $this->container->get('router')->generate('sonata_admin_dashboard', $parameters, $referenceType, $perfilLogado));
        }

//        echo 'Rastreabilidade! 1º. Inicializa tela de login em AdminSecurityController (loginAction) perfil logado: '.$perfilLogado.'                             ';
//        echo '\Sonata\UserBundle\Controller\AdminSecurityController em \vendor\sonata-project\user-bundle\Controller\AdminSecurityController.php';
