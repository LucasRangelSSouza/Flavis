...
class ResourcesTestDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($a, array('config' => new \Symfony\Bundle\AsseticBundle\Factory\Loader\ConfigurationLoader(), 'twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), NULL), $c, true), 'php' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Symfony\Bundle\AsseticBundle\Factory\Loader\AsseticHelperFormulaLoader($a), $c, true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery' => array(0 => array(0 => 'js/jquery.js'), 1 => array(), 2 => array()), 'app_css' => array(0 => array(0 => 'css/main.css', 1 => 'css/more.css', 2 => '@widget_css'), 1 => array(0 => '?yui_css'), 2 => array('output' => 'css/packed/app.css')), 'widget_css' => array(0 => array(0 => 'css/widget.sass'), 1 => array(0 => 'sass'), 2 => array()))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'TestBundle', ($this->targetDirs[2].'/Resources/TestBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'TestBundle', ($this->targetDirs[3].'\\TestBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'TestBundle', ($this->targetDirs[2].'/Resources/TestBundle/views'), '/\\.[^.]+\\.php$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, 'TestBundle', ($this->targetDirs[3].'\\TestBundle/Resources/views'), '/\\.[^.]+\\.php$/'))), 'php');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter('%kernel.root_dir/java/yui-compressor-2.4.6.jar', 'C:\\ProgramData\\Oracle\\Java\\javapath\\java.EXE');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('sass' => 'assetic.filter.sass', 'yui_css' => 'assetic.filter.yui_css'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array('yui_css' => array('output' => 'css/*.css')), array(0 => 'TestBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[5].'\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views'), 'Framework');
        $instance->addPath(($this->targetDirs[5].'\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views'), 'Twig');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'debug.container.dump' => (__DIR__.'/ResourcesTestDebugProjectContainer.xml'),
            ...
            'assetic.filter.yui_css.jar' => '%kernel.root_dir/java/yui-compressor-2.4.6.jar',
