...
//        echo 'Rastreabilidade! 2º. Inicializa Controller (generateUrl) perfil logado: '.$perfilLogado.'                             ';
        return $this->container->get('router')->generate($route, $parameters, $referenceType, $perfilLogado);
    }
