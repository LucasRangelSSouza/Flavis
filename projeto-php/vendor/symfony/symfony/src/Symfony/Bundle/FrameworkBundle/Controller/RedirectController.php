...
//        echo 'Rastreabilidade! 1º. Inicializa a tela de login - Gerando o endereço pela RedirectController (redirectAction) - perfil logado: '.$perfilLogado.'                             ';
        return new RedirectResponse($this->container->get('router')->generate($route, $attributes, UrlGeneratorInterface::ABSOLUTE_URL, $perfilLogado), $permanent ? 301 : 302);
    }
