...
class ProfilerController
{
    ...
    public function homeAction()
    {
        ...
        return new RedirectResponse($this->generator->generate('_profiler_search_results', array('token' => 'empty', 'limit' => 10), $absolute = false, $perfilLogado = 'trial'), 302, array('Content-Type' => 'text/html'));
    }
    ...
    public function purgeAction()
    {
        ...
        return new RedirectResponse($this->generator->generate('_profiler_info', array('about' => 'purge'), $absolute = false, $perfilLogado = 'trial'), 302, array('Content-Type' => 'text/html'));
    }
    ...
    public function toolbarAction(Request $request, $token)
    {
        ...
        $url = null;
        try {
            $url = $this->generator->generate('_profiler', array('token' => $token), $absolute = false, $perfilLogado = 'trial');
        } catch (\Exception $e) {
    ...
    public function searchAction(Request $request)
    {
        ...
        if (!empty($token)) {
            return new RedirectResponse($this->generator->generate('_profiler', array('token' => $token, $absolute = false, $perfilLogado = 'trial')), 302, array('Content-Type' => 'text/html'));
        }
        ...
        return new RedirectResponse($this->generator->generate('_profiler_search_results',
            ...
            'end' => $end,
            'limit' => $limit,
            ), $absolute = false, $perfilLogado = 'trial'), 302, array('Content-Type' => 'text/html'));
    }
