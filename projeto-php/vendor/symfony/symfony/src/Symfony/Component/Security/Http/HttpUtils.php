 ...
 */
class HttpUtils extends ContainerAware
{
    /**
...
//        echo 'Rastreabilidade! Método generateUrl em HttpUtils - perfil logado: '.$perfilLogado.'                             ';
        $url = $this->urlGenerator->generate($path, $request->attributes->all(), UrlGeneratorInterface::ABSOLUTE_URL, $perfilLogado);
