...
/** 
 * DAO for table "COLABORADOR".
*/
public class ColaboradorDao extends AbstractDao<Colaborador, Long> {

    public static final String TABLENAME = "COLABORADOR";

    /**
     * Properties of entity Colaborador.<br/>
    ...
    public ColaboradorDao(DaoConfig config) {
        super(config);
    }
    
    public ColaboradorDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLABORADOR\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COLABORADOR\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Colaborador entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Colaborador entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(Colaborador entity) {
    ...
    @Override
    public Colaborador readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, Colaborador entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Colaborador entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Colaborador entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Colaborador entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM COLABORADOR T");
    ...
    protected Colaborador loadCurrentDeep(Cursor cursor, boolean lock) {
        Colaborador entity = loadCurrent(cursor, 0, lock);
    ...
    public Colaborador loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Colaborador> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Colaborador> list = new ArrayList<Colaborador>(count);
    ...
    protected List<Colaborador> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Colaborador> queryDeep(String where, String... selectionArg) {
