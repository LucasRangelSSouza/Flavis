...
/** 
 * DAO for table "FUNCAO".
*/
public class FuncaoDao extends AbstractDao<Funcao, Long> {

    public static final String TABLENAME = "FUNCAO";

    /**
     * Properties of entity Funcao.<br/>
    ...
    public FuncaoDao(DaoConfig config) {
        super(config);
    }
    
    public FuncaoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FUNCAO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FUNCAO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Funcao entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Funcao entity) {
        stmt.clearBindings();
    ...
    @Override
    public Funcao readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, Funcao entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Funcao entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Funcao entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Funcao entity) {
